...
describe("extensions page tests", () => {
  ...
  const extensions = process.env.EXTENSION_PATH
    ...
    : [
        "@skuberplus/example-extension",
        "@skuberplus/example-extension@1.3.0",
        "@skuberplus/extension-example@1.2.0",
        "@skuberplus/extension-example@1.0.0",
        "@skuberplus/skuberplus-node-pod-menu",
        "@skuberplus/skuberplus-node-pod-menu@1.1.0",
        "@skuberplus/skuberplus-node-pod-menu@1.0.0",
      ];
