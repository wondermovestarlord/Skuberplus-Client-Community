...
describeIf(kindReady(TEST_KIND_CLUSTER_NAME, TEST_NAMESPACE))("KinD based tests", () => {
  ...
  // FIXME: failed locally since metrics might already exist
