...
const daiveAiExtensionInjectable = getInjectable({
  ...
  instantiate: () => ({
    ...
    main: () => {
      console.log("🚀 DAIVE AI Extension Main 로딩 중...");
      console.log("✅ DAIVE AI Extension Main 성공적으로 로드됨!");
      return null; // Main process에서는 특별한 로직이 필요없어서 null
    },
    renderer: () => {
      console.log("🎨 DAIVE AI Extension Renderer 로딩 중...");
      console.log("✅ DAIVE AI Extension Renderer 성공적으로 로드됨!");
...
//# sourceMappingURL=bundled-extensions.injectable.js.map
