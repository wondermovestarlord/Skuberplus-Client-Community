...
export { reactRootLifecycleInjectionToken } from "./src/render-application/react-root-lifecycle-injection-token";
...
export type { ReactRootLifecycle } from "./src/render-application/react-root-lifecycle-injection-token";
