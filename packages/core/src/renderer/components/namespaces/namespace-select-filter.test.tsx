...
describe("<NamespaceSelectFilter />", () => {
  ...
  beforeEach(() => {
    ...
    di.unoverride(clusterFrameContextForNamespacedResourcesInjectable);
    di.unoverride(selectedNamespacesStorageInjectable);
  ...
  describe("once the subscribe resolves", () => {
    ...
    describe("when clicked", () => {
      ...
      describe("when 'test-2' is clicked", () => {
        beforeEach(() => {
          result.getAllByText("test-2")[0].click();
        });
        ...
        describe("when clicked again", () => {
          ...
          describe("when 'test-1' is clicked", () => {
            beforeEach(() => {
              result.getAllByText("test-1")[0].click();
            });
            ...
            describe("when clicked again, then holding down multi select key", () => {
              ...
              describe("when 'test-3' is clicked", () => {
                beforeEach(() => {
                  result.getAllByText("test-3")[0].click();
                });
                ...
                describe("when 'test-13' is clicked", () => {
                  beforeEach(() => {
                    result.getAllByText("test-13")[0].click();
                  });
                  ...
                  it("'test-13' is not sorted to the top of the list", () => {
                    const topLevelElement = result.getAllByText("test-13")[0].parentElement
      ...
      describe("when multi-selection key is pressed", () => {
        ...
        // TODO: selectedNamespacesStorage 초기화 타이밍으로 placeholder 비어있음
        it.skip("should show placeholder text as 'All namespaces'", () => {
          expect(
