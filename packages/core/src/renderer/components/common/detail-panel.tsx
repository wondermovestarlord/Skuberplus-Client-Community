 ...
 *
 * @remarks
 * - CommonTable 템플릿의 Detail Panel 패턴 추출
 * - 헤더/콘텐츠/푸터 레이아웃 제공
 ...
 * - 2025-11-21: CSS transition 애니메이션으로 변경 (Tailwind v4 호환성 개선)
...
export function DetailPanel({
  ...
  return (
    <>
      {/* 🎨 우측 패널 */}
      <div
        className={`bg-card fixed inset-y-0 right-0 z-50 flex h-full flex-col border-l shadow-lg ${width} ${className}`}
      >
        {/* ============================================ */}
        {/* 🎯 고정 헤더 영역 */}
        {/* ============================================ */}
