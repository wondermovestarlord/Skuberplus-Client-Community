 ...
 * - 2025-11-21: packages/core로 복사 (DetailPanel과 함께 사용)
  ...
  return (
    <DropdownMenu>
      ...
      <DropdownMenuContent align="end">
        ...
        {/* 🎯 THEME-024: Semantic color for destructive actions */}
        {onForceFinalize && (
          <DropdownMenuItem variant="destructive" className="!text-status-error" onClick={onForceFinalize}>
        ...
        {onDelete && (
          <DropdownMenuItem variant="destructive" className="!text-status-error" onClick={onDelete}>
        ...
        {isPod && onForceDelete && (
          <DropdownMenuItem variant="destructive" className="!text-status-error" onClick={onForceDelete}>
