...
/**
 * 🎯 목적: ResourceQuotas 메인 컴포넌트
 *
 * 구성:
 * - SiblingsInTabLayout으로 감싼 ResourceQuotasCommonTable
 * - AddQuotaDialog 포함
...
import { ResourceQuotasCommonTable } from "./resource-quotas-common-table";

/**
 * 🎯 목적: ResourceQuotas 컴포넌트 (Tab 레이아웃)
 */
export const ResourceQuotas = () => {
  return (
    <SiblingsInTabLayout>
      <ResourceQuotasCommonTable />
      <AddQuotaDialog />
    </SiblingsInTabLayout>
  );
};
