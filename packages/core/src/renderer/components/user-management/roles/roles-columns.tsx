...
/**
 * 🎯 목적: Role 테이블의 TanStack Table 컬럼 정의
 *
 * @remarks
 * - KubeDataTable에서 사용할 Role 전용 컬럼 정의
...
export const roleColumns: ColumnDef<Role>[] = [
  ...
  // ============================================
  {
    ...
    cell: ({ row }) => {
      ...
      return (
        <div className="px-3">
          <WithTooltip>
            <div className="font-medium">{role.getName()}</div>
          </WithTooltip>
        </div>
      );
    },
  ...
  // ============================================
  {
    ...
    cell: ({ row }) => {
      const role = row.original;
      return <KubeObjectStatusIcon object={role} />;
    },
    size: 24,
    enableSorting: false,
    enableResizing: false,
  ...
  // ============================================
  {
    ...
    cell: ({ row }) => {
      ...
      return (
        <div className="px-3">
          <NamespaceSelectBadge namespace={role.getNs()} />
        </div>
      );
    },
    size: 150,
