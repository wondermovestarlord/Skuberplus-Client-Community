...
/**
 * 🎯 목적: Helm Releases 메인 export - shadcn UI KubeDataTable 기반 컴포넌트 사용
 *
 * @remarks
 * - 기존 ItemListLayout 기반 구현을 주석 처리 (백업 유지)
 * - shadcn UI KubeDataTable 기반 ReleasesCommonTable 사용
 * - SCSS 제거, TailwindCSS 완전 적용
 *
 * 🔄 변경이력:
 * - 2025-10-31: shadcn UI 마이그레이션 (Pod 패턴 적용)
 */

// 🎯 목적: KubeDataTable 기반 shadcn UI 컴포넌트 사용
export { ReleasesCommonTable as HelmReleases } from "./releases-common-table";

/* ============================================
 * 기존 ItemListLayout 기반 구현 (백업)
 * ============================================
