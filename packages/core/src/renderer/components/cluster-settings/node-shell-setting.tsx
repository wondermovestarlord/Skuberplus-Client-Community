...
@observer
export class ClusterNodeShellSetting extends Component<ClusterNodeShellSettingProps> {
      ...
      <>
        <section>
          ...
          <Input
            ...
            iconRight={
              this.nodeShellImage ? (
                <Icon smallest material="close" onClick={() => (this.nodeShellImage = "")} tooltip="Reset" />
              ) : undefined
            }
          />
          <small className="hint">Node shell image. Used for creating node shell pod on Linux nodes.</small>
        </section>
        <Gutter />
        <section>
          ...
          <Input
            ...
            iconRight={
              this.nodeShellWindowsImage ? (
                <Icon smallest material="close" onClick={() => (this.nodeShellWindowsImage = "")} tooltip="Reset" />
              ) : undefined
            }
          />
          <small className="hint">Node shell image. Used for creating node shell pod on Windows nodes.</small>
        </section>
        <Gutter />
        <section>
          ...
          <Input
            ...
            iconRight={
              this.imagePullSecret ? (
                <Icon smallest material="close" onClick={() => (this.imagePullSecret = "")} tooltip="Clear" />
              ) : undefined
            }
          />
          <small className="hint">
            Name of a pre-existing secret in the kube-system namespace. An optional setting. Used for pulling image from
            a private registry.
          </small>
        </section>
      </>
