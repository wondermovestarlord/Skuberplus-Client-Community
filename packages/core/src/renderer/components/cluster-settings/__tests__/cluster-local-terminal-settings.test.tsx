...
describe("ClusterLocalTerminalSettings", () => {
  ...
  beforeEach(() => {
    ...
    // 🎯 FIX-037: Clear notification store before each test
    notificationPanelStore.clearAll();
  ...
  it("should not save the new CWD if path is a file", async () => {
    ...
    // 🎯 FIX-037: Check notificationPanelStore instead of mock
    await waitFor(() => {
      const errorNotifications = notificationPanelStore.notifications.filter((n) => n.type === "error");
