      ...
      <>
        <div className="flex" data-testid={`catalog-entity-details-content-for-${entity.getId()}`}>
          ...
          <div className={cssNames("box grow", styles.metadata)}>
            <DetailPanelField label="Name">{entity.getName()}</DetailPanelField>
            <DetailPanelField label="Kind">{entity.kind}</DetailPanelField>
            <DetailPanelField label="Source">{entity.getSource()}</DetailPanelField>
            <DetailPanelField label="Status">{entity.status.phase}</DetailPanelField>
            <DetailPanelField label="Labels">{getLabelBadges(entity, hideDetails)}</DetailPanelField>
            {isDevelopment && <DetailPanelField label="Id">{entity.getId()}</DetailPanelField>}
          </div>
        </div>
