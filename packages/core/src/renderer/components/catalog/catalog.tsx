...
import { Hotbar as HotbarComponent } from "../shadcn-ui/hotbar";
...
class NonInjectedCatalog extends Component<Dependencies> {
  ...
  async componentDidMount() {
    const { catalogEntityStore, catalogPreviousActiveTabStorage, catalogCategoryRegistry, logger } = this.props;
      ...
      reaction(
        ...
        async (routeTab) => {
          ...
          try {
            ...
            notificationPanelStore.addError("system", "Unknown Category", `Unknown category: ${routeTab}`);
          }
        },
  ...
  render() {
    ...
    return (
      <MainLayout
        ...
        sidebar={<CatalogMenu activeTab={this.activeTab} onItemClick={this.onTabChange} />}
      >
...
export const Catalog = withInjectables<Dependencies>(observer(NonInjectedCatalog), {
  getProps: (di, props) => ({
    ...props,
