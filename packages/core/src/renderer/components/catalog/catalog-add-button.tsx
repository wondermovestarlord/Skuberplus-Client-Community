...
class NonInjectedCatalogAddButton extends Component<CatalogAddButtonProps & Dependencies> {
...
export const CatalogAddButton = withInjectables<Dependencies, CatalogAddButtonProps>(
  observer(NonInjectedCatalogAddButton),
  {
    getProps: (di, props) => ({
      ...props,
