...
class NonInjectedPodSecurityPolicies extends Component<Dependencies> {
  render() {
    return (
      <SiblingsInTabLayout>
...
export const PodSecurityPolicies = withInjectables<Dependencies>(observer(NonInjectedPodSecurityPolicies), {
  getProps: (di, props) => ({
    ...props,
