...
function NonInjectedNamespaceKubernetesClusterSettings({
  entity,
  getClusterById,
...
const NamespaceKubernetesClusterSettings = withInjectables<Dependencies, EntitySettingViewProps>(
  NonInjectedNamespaceKubernetesClusterSettings,
  {
    getProps: (di, props) => ({
      ...props,
