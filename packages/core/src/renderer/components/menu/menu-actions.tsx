...
class NonInjectedMenuActions extends Component<MenuActionsProps & Dependencies> {
  static defaultProps = {
...
export const MenuActions = withInjectables<Dependencies, MenuActionsProps>(observer(NonInjectedMenuActions), {
  getProps: (di, props) => ({
