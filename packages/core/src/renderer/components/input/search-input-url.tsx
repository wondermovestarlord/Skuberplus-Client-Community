...
class NonInjectedSearchInputUrl extends Component<SearchInputUrlProps & Dependencies> {
...
export const SearchInputUrl = withInjectables<Dependencies, SearchInputUrlProps>(observer(NonInjectedSearchInputUrl), {
  getProps: (di, props) => ({
    ...props,
