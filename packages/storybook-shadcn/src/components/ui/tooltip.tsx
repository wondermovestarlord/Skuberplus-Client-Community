 ...
 *   - 2026-01-27 - disableHoverableContent=true 추가 (툴팁 호버 동작 일관성)
 */
 ...
 * 🔄 변경이력:
 *   - 2025-10-11 - React 18/19 dual support 검토 (ref 미지원 확인)
 *   - 2026-02-09 - Provider props(disableHoverableContent 등) 전달 지원 추가
 */
function Tooltip({
  ...
  Pick<React.ComponentProps<typeof TooltipPrimitive.Provider>, "disableHoverableContent" | "delayDuration">) {
  return (
